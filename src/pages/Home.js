    ...
    <div className="home text-center">
      <div className="about-home">
        ...
        <div className="prompt mt-5">
          <p>
            Computer science graduate with a zeal for
            innovation. Seeking a position
            where the strategic focus aligns
            with my creativity and desire to
            enhance myself as well as social
